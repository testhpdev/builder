...
class HTMXPagesListView(generic.ListView):
    model = models.Pages
...
class HTMXPagesCreateView(generic.CreateView):
    model = models.Pages
    form_class = forms.PagesForm
...
class HTMXPagesDeleteView(generic.DeleteView):
    model = models.Pages
    success_url = reverse_lazy("page_management_Pages_htmx_list")
